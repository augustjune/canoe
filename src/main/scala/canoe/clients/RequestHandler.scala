...
import canoe.marshalling.marshalling._
import canoe.methods.Request
import canoe.methods.chats._
import canoe.methods.files.GetFile
import canoe.methods.games.{GetGameHighScores, SetGameScore}
import canoe.methods.messages._
import canoe.methods.queries.{AnswerCallbackQuery, AnswerInlineQuery, AnswerPreCheckoutQuery, AnswerShippingQuery}
import canoe.methods.stickers._
import canoe.methods.updates.GetUpdates
import canoe.methods.users.{GetMe, GetUserProfilePhotos}
import canoe.methods.webhooks.{DeleteWebhook, GetWebhookInfo, SetWebhook}
