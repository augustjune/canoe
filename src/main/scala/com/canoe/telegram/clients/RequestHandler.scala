...
import com.canoe.telegram.methods._
import com.canoe.telegram.methods.chats._
import com.canoe.telegram.methods.messages._
import com.canoe.telegram.methods.files._
import com.canoe.telegram.methods.games._
import com.canoe.telegram.methods.queries._
import com.canoe.telegram.methods.stickers._
import com.canoe.telegram.methods.updates._
import com.canoe.telegram.methods.users._
import com.canoe.telegram.methods.webhooks._
import com.canoe.telegram.models.Response
import com.canoe.telegram.marshalling.marshalling._
import io.circe.generic.auto._
import io.circe.{Decoder, Encoder}
import cats.implicits._

abstract class RequestHandler[F[_]](implicit monadError: MonadError[F, Throwable]) {
  ...
  /** Spawns a type-safe request.
    ...
    * @return The request result wrapped in `F`
    */
  def execute[R](request: Request[R]): F[R] =
    for {
