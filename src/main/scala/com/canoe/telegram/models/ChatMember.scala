...
/** This object contains information about one member of the chat.
  ...
  * @param canChangeInfo          Boolean	Optional. Administrators only. True, if the administrator can change the chat title, photo and other settings
  ...
  * @param canInviteUsers         Boolean	Optional. Administrators only. True, if the administrator can invite new users to the chat
